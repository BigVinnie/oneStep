...
$cart = $('.containerStickyCart'), $cartClick = $('.noCart');
...
$optionsButton = $('.optionsButton'), $optionsList = $('.sidebarOptions ul');
...
$(window).mouseleave(function() {
	var degree = 0;
	$(".compas").css('-webkit-transform', 'rotate(' + degree + 'deg)'), ('-moz-transform', 'rotate(' + degree + 'deg)'), ('-o-transform', 'rotate(' + degree + 'deg)'), ('-ms-transform', 'rotate(' + degree + 'deg)');
}); /*=== Home image hover ===*/
$('.containerFeatured').hover(function() {
	$('.captionOverlay').stop().animate({
		height: "50px"
	}, 200);
}, function() {
	$('.captionOverlay').stop().animate({
